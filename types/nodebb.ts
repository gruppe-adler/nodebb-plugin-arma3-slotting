...
export interface IDb {
    ...
    getObjectField: (key: string, property: string, callback?: DbCallback) => Promise<any>;
    setObjectField: (key: string, property: string, value: string, callback?: DbCallback) => Promise<any>;
}
